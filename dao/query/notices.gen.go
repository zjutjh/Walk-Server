...
func newNotice(db *gorm.DB, opts ...gen.DOOption) notice {
	...
	_notice.UserID = field.NewInt64(tableName, "user_id")
	_notice.Type = field.NewString(tableName, "type")
	_notice.ActorID = field.NewInt64(tableName, "actor_id")
	_notice.ActorName = field.NewString(tableName, "actor_name")
	_notice.TeamID = field.NewInt64(tableName, "team_id")
	_notice.ReadAt = field.NewTime(tableName, "read_at")
...
type notice struct {
	...
	ALL       field.Asterisk
	ID        field.Int64
	UserID    field.Int64  // 接收通知的用户ID
	Type      field.String // 通知类型
	ActorID   field.Int64  // 发起操作的用户ID
	ActorName field.String // 发起人姓名快照
	TeamID    field.Int64  // 相关队伍ID
	ReadAt    field.Time   // 确认时间，NULL表示未读
...
func (n *notice) updateTableName(table string) *notice {
	...
	n.ActorID = field.NewInt64(table, "actor_id")
	n.ActorName = field.NewString(table, "actor_name")
	n.TeamID = field.NewInt64(table, "team_id")
...
func (n *notice) fillFieldMap() {
	...
	n.fieldMap["actor_id"] = n.ActorID
	n.fieldMap["actor_name"] = n.ActorName
	n.fieldMap["team_id"] = n.TeamID
